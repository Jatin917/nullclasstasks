...
function App() {
  ...
  console.log("raw data post", rawDataPost)
useEffect(()=>{
...
useEffect(()=>{
  if(targetLang) dispatch(translator(targetLang, rawDataQuestion, "QUESTIONS"));
...
useEffect(()=>{
  ...
  return (
    <div className="App">
      <Router>
      <Navbar targetLang={targetLang} setTargetLang={setTargetLang} handleslidein={handleslidein}/>
